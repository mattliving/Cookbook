...
public class BookmarksActivity extends BasicListActivity {
    
	protected String name = "Bookmarks";
	protected String emptyMessage = "No Bookmarks Added yet";
	...
	/**
	 * Get the ids from the "bookmarks" file in res->raw and add their correspondent recipe
